...
Container(
            ...
            child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Expanded(child: Text(
                'تنبيه: قد يختلف الوزن الفعلي لبعض المنتجات عند التجهيز. سيتم احتساب السعر وفق الوزن النهائي، مع استرداد أي فرق للمحفظة أو إضافته إلى الفاتورة حسب الوزن الفعلي.',
